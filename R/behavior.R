...
#' Extract 'momentuHMM' transition matrix probabilities
#'
#' @usage ExtractTransitionProbabilities(x, alpha = 0.95)
#' @param x =  object
#' @param alpha = p-value for CI
#'
#' @details This function is based on momentuHMM:::plot function. There may be
#'     a lot of extraneous code because it was difficult to extract only the
#'     necessary code for creating the transition matrix.
#' @return a tibble
#' @export
#'
